...
class photobooth_settings:
    def __init__(self, top=None):
        ...
        self.btnSave.configure(font=font11)
        ...
        self.TLabel1.place(relx=0.11, rely=0.28, height=19, width=61)
        self.TLabel1.configure(background="#d9d9d9")
        self.TLabel1.configure(foreground="#000000")
        self.TLabel1.configure(relief=FLAT)
        self.TLabel1.configure(justify=RIGHT)
        self.TLabel1.configure(text='''Print style:''')

        self.cbPrintFormat = ttk.Combobox(top)
        self.cbPrintFormat.place(x=140, y=114, height=21, width=124)
        ...
        self.Label5.place(relx=0.07, rely=0.36, height=21, width=90)
        ...
        self.cbDelayScreen.place(x=140, y=146, height=21, width=124)
        ...
        self.TLabel2.place(relx=0.03, rely=0.44, height=19, width=110)
        ...
        self.txtSAP.place(x=140, y=176, height=21, width=84)
        ...
        self.TLabel3.place(relx=0.38, rely=0.45, height=19, width=20)
        ...
        self.Canvas1.place(x=20, y=210, height=153, width=186)
        ...
        self.Label2.place(relx=0.01, rely=0.1, height=21, width=54)
        ...
        self.Label2.configure(width=54)
        ...
        self.ckPreviewScreen.place(x=410, y=90, height=25, width=111)
        ...
        self.Label1.place(relx=0.54, rely=0.36, height=21, width=117)
        ...
        self.Label7.place(relx=0.52, rely=0.42, height=21, width=118)
        ...
        self.txtEndDelay.place(x=435, y=142, height=21, width=64)
        ...
        self.txtPreviewDelay.place(x=435, y=169, height=21, width=64)
        ...
        self.TLabel4.place(relx=0.85, rely=0.43, height=19, width=20)
        self.TLabel4.configure(background="#d9d9d9")
        self.TLabel4.configure(foreground="#000000")
        self.TLabel4.configure(relief=FLAT)
        self.TLabel4.configure(text='''ms''')

        self.TLabel5 = ttk.Label(top)
        self.TLabel5.place(relx=0.85, rely=0.36, height=19, width=20)
        self.TLabel5.configure(background="#d9d9d9")
        self.TLabel5.configure(foreground="#000000")
        self.TLabel5.configure(relief=FLAT)
        self.TLabel5.configure(text='''ms''')

        self.btnPreviewPrintStyle = Button(top)
        self.btnPreviewPrintStyle.place(relx=0.45, rely=0.28, height=24
                , width=57)
        self.btnPreviewPrintStyle.configure(activebackground="#d9d9d9")
        self.btnPreviewPrintStyle.configure(activeforeground="#000000")
        self.btnPreviewPrintStyle.configure(background="#d9d9d9")
        self.btnPreviewPrintStyle.configure(command=settings_support.onPreviewPrintStyle)
        self.btnPreviewPrintStyle.configure(disabledforeground="#a3a3a3")
        self.btnPreviewPrintStyle.configure(foreground="#000000")
        self.btnPreviewPrintStyle.configure(highlightbackground="#d9d9d9")
        self.btnPreviewPrintStyle.configure(highlightcolor="black")
        self.btnPreviewPrintStyle.configure(pady="0")
        self.btnPreviewPrintStyle.configure(text='''Preview''')

        self.ckShowMouse = Checkbutton(top)
        self.ckShowMouse.place(x=410, y=110, height=25, width=101)
        self.ckShowMouse.configure(activebackground="#d9d9d9")
        self.ckShowMouse.configure(activeforeground="#000000")
        self.ckShowMouse.configure(background="#d9d9d9")
        self.ckShowMouse.configure(disabledforeground="#a3a3a3")
        self.ckShowMouse.configure(foreground="#000000")
        self.ckShowMouse.configure(highlightbackground="#d9d9d9")
        self.ckShowMouse.configure(highlightcolor="black")
        self.ckShowMouse.configure(justify=LEFT)
        self.ckShowMouse.configure(offvalue="False")
        self.ckShowMouse.configure(onvalue="True")
        self.ckShowMouse.configure(text='''Show mouse''')
        self.ckShowMouse.configure(variable=settings_support.ckShowMouseVar)
        self.ckShowMouse.configure(width=101)

        self.Label3 = Label(top)
        self.Label3.place(relx=0.51, rely=0.48, height=31, width=214)
        self.Label3.configure(background="#d9d9d9")
        self.Label3.configure(disabledforeground="#a3a3a3")
        self.Label3.configure(foreground="#000000")
        self.Label3.configure(text='''If preview screen delay set to 0 then continue by tap''')
        self.Label3.configure(width=214)
